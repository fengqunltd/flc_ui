...
const CORE_ASSET = "FLC"; // Setting this to FLC to prevent loading issues when used with FLC chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise((resolve) => {
            ...
            let topMarkets = {
                markets_4018d784: [ // FLC MAIN NET
                    "OPEN.MKR", "FLC", "OPEN.ETH", "ICOO", "BTC", "OPEN.LISK", "BKT",
                    "OPEN.STEEM", "OPEN.GAME", "OCT", "USD", "CNY", "FLCR", "OBITS",
            ...
            let coreAssets = {markets_4018d784: "FLC", markets_39f5e2ed: "TEST"};
            let coreAsset = coreAssets[this.starredKey] || "FLC";
